<<<<<<<< HEAD:scriptsSQL/donnees_bdd.sql
...
UPDATE user SET balance = 2 WHERE id = 1 AND email = 'applicationBalance'; 
...
(3, 5),
(4, 5),
>>>>>>>> c30652106894fa32609aaf71881833822dabae8c:scriptsSQL/données_bdd.sql
(4, 3);